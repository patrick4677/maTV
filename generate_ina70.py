...
# Utilisation de l'API globale du guide Pluto TV France
API_URL = "https://api.pluto.tv/v2/channels?region=FR"
...
def main():
    ...
    try:
        ...
        print(f"Erreur API Pluto TV: {e}")
        sys.exit(1)

    # Recherche de la chaîne INA 70 dans la liste
    ina_channel = None
